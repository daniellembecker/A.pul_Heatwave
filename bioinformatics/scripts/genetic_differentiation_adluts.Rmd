...
## Read in genetic differentiation .vcf file made from original sample .bam files, called for SNP variants, and filtered
```{r}
# Convert filtered .vcf file to GDS format
vcf.fn <- "filtered_output.vcf"  # Replace with your VCF file path
gds.fn <- "your_study.gds"

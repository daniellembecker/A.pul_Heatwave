...
DEG.sig <- read.csv("bioinformatics/output/larvae_deg.csv")[,-1]
...
The annotation file now only contains genes that were detected in our dataset that have annotation information. This is 19,157 out of the 70,239 genes in our dataset. 

19,157 genes were retained in the filtered GO dataset. Write table for GO MWU analysis 
```{r}
...
```
2633 DEGs in filt_counts_annot

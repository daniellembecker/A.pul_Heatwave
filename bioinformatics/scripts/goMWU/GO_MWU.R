...
getwd()
setwd("bioinformatics/scripts/goMWU/")

# Edit these to match your data file names: 
input="DEGs_sig.csv" # two columns of comma-separated values: gene id, continuous measure of significance. To perform standard GO enrichment analysis based on Fisher's exact test, use binary measure (0 or 1, i.e., either sgnificant or not).
...
gomwuStats(input, goDatabase, goAnnotations, goDivision,
           ...
           largest=0.95,  # a GO category will not be considered if it contains more than this fraction of the total number of genes
           smallest=1,   # a GO category should contain at least this many genes to be considered
           clusterCutHeight=0.2, # threshold for merging similar (gene-sharing) terms. See README for details.

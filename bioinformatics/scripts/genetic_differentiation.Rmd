...
```
# FST = 0.05, at the upper limit of the low differentiation category, it suggests some level of population structure but not enough to indicate substantial genetic divergence.
...
print(paste("P-value from permutation test:", result.adult$p_value)) # 0.21 suggests not enough evidence to conclude the observed differentiation is statistically significant, could be due to natural variation

...
```{r}
ggsave("heatwave/output/volcano_treatment.png", plot=volcano_plot_adults, width=18, height=6)
```
...
```{r}
ggsave("heatwave/output/DEG_heatmap_adults.png", plot=DEGSeq2_heatmap_adults, width=18, height=6)
```
...
ggsave("heatwave/output/pca_DEG_adults.png", DEG_PCA_adult, width=8, height=4)
```

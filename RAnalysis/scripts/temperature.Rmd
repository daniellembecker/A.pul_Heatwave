...
```{r}
mahana.temp.hobo.06 <- read.csv("../A.pul_Gametogenesis/RAnalysis/data/environmental/HOBO_temperature/20220415_Mahana_6.csv")
mahana.temp.hobo.09 <- read.csv("../A.pul_Gametogenesis/RAnalysis/data/environmental/HOBO_temperature/20220415_Mahana_9.csv")
mahana.temp.hobo.07 <- read.csv("../A.pul_Gametogenesis/RAnalysis/data/environmental/HOBO_temperature/20220415_Mahana_7.csv")
mahana.temp.hobo.10 <- read.csv("../A.pul_Gametogenesis/RAnalysis/data/environmental/HOBO_temperature/20221114_Mahana_10.csv")
mahana.temp.hobo.11 <- read.csv("../A.pul_Gametogenesis/RAnalysis/data/environmental/HOBO_temperature/20221114_Mahana_11.csv")
mahana.temp.hobo.12 <- read.csv("../A.pul_Gametogenesis/RAnalysis/data/environmental/HOBO_temperature/20221114_Mahana_12.csv")
mahana.temp.hobo.13 <- read.csv("../A.pul_Gametogenesis/RAnalysis/data/environmental/HOBO_temperature/20221114_Mahana_13.csv")
mahana.temp.hobo.08 <- read.csv("../A.pul_Gametogenesis/RAnalysis/data/environmental/HOBO_temperature/20221114_Mahana_8.csv")
mahana.temp.hobo.05 <- read.csv("../A.pul_Gametogenesis/RAnalysis/data/environmental/HOBO_temperature/20221114_Mahana_5.csv")
mahana.temp.hobo.04 <- read.csv("../A.pul_Gametogenesis/RAnalysis/data/environmental/HOBO_temperature/20221114_Mahana_4.csv")
mahana.temp.hobo.03 <- read.csv("../A.pul_Gametogenesis/RAnalysis/data/environmental/HOBO_temperature/20221114_Mahana_3.csv")
mahana.temp.hobo.02 <- read.csv("../A.pul_Gametogenesis/RAnalysis/data/environmental/HOBO_temperature/20221114_Mahana_2.csv")
```
...
#subset temp data for until end of october
```{r}

# Convert the date column to Date type using lubridate
temp.data$date <- ymd_hms(temp.data$date.time)

# filter temp data to show after october spawning
filtered_data <- temp.data %>%
  filter(date < ymd_hms("2022-11-01 18:00:00"))
...
filtered_data$month <- factor(month(filtered_data$date.time), levels = 1:12, labels = month.abb)  # Extract month from date as factor

# Define the date ranges for shading
shading_ranges <- data.frame(
  start = ymd_hms(c("2022-03-13 00:00:00", "2022-04-19 00:00:00", "2022-10-14 00:00:00", "2022-10-30 00:00:00")),
  end = ymd_hms(c("2022-04-19 00:00:00", "2022-10-14 00:00:00", "2022-10-30 00:00:00", "2022-11-01 18:00:00")),
  fill = c("#E69F00", "#56B4E9", "#00796B","#9467BD") # Colors for the shaded regions
)

# Plot mean sea surface temperature per month with variation around the mean
temp.plot <- ggplot(filtered_data, aes(x = date.time, y = temp)) + 
  # Add shaded regions for the specified periods
  geom_rect(data = shading_ranges, inherit.aes = FALSE,
            aes(xmin = start, xmax = end, ymin = -Inf, ymax = Inf, fill = I(fill)),
  ...
  ylim(25, 30);temp.plot

# save mean temp per month plot
ggsave("output/temp.plot.jpg", temp.plot , width = 10, height = 6)
ggsave("output/temp.plot.pdf", temp.plot , width = 10, height = 6)

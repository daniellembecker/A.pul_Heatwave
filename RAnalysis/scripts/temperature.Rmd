...
filtered_data <- temp.data %>%
  filter(date < ymd_hms("2022-10-30 00:00:00"))
...
shading_ranges <- data.frame(
  start = ymd_hms(c("2022-03-13 00:00:00", "2022-04-19 00:00:00", "2022-10-14 00:00:00")),
  end = ymd_hms(c("2022-04-19 00:00:00", "2022-10-14 00:00:00", "2022-10-29 00:00:00")),
  fill = c("yellow3", "orange", "purple") # Colors for the shaded regions
)

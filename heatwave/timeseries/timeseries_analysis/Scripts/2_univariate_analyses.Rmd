...
timepoint           2.7402e+12 9.1339e+11     3        Inf  4.5875 0.003247 **
treatment           1.0416e+12 1.0416e+12     1 1.1543e+39  5.2313 0.022183 * 
timepoint:treatment 4.6172e+11 1.5391e+11     3        Inf  0.7730 0.508898   
...
Type III Analysis of Variance Table with Satterthwaite's method
                    Sum Sq Mean Sq NumDF DenDF F value   Pr(>F)    
timepoint           42.315 14.1051     3    88 15.5012 3.54e-08 ***
treatment            6.115  6.1147     1    88  6.7200  0.01116 *  
timepoint:treatment  0.273  0.0908     3    88  0.0998  0.95990  
...
Type III Analysis of Variance Table with Satterthwaite's method
                     Sum Sq Mean Sq NumDF DenDF F value    Pr(>F)    
timepoint           133.944  44.648     3    88 51.1823 < 2.2e-16 ***
treatment             6.696   6.696     1    88  7.6762  0.006826 ** 
timepoint:treatment   5.130   1.710     3    88  1.9601  0.125824     


# For tot chl

`tot_chl_model <- lmer(Total_Chl_cm2~timepoint*treatment+(1|colony_ID), na.action=na.omit, data=master)` 
...
`tot_chl_model<-lmer(log(Total_Chl_cm2~timepoint*treatment+(1|colony_ID), na.action=na.omit, data=master))` 
...
Type III Analysis of Variance Table with Satterthwaite's method
                    Sum Sq Mean Sq NumDF DenDF F value    Pr(>F)    
timepoint           320.21 106.737     3    88 34.7833 6.401e-15 ***
treatment            25.61  25.609     1    88  8.3453  0.004867 ** 
timepoint:treatment   7.42   2.474     3    88  0.8063  0.493713      

...
emm_P <-emmeans(P_model, ~ timepoint:Treatment)
pairs(emm_P)
...
# run post hoc on timepoints and treatment
emm_rd <-emmeans(rd_model, ~ timepoint:Treatment)
pairs(emm_rd)
...
# run post hoc on timepoints and treatment
emm_GP <-emmeans(GP_model, ~ timepoint:Treatment)
pairs(emm_GP)

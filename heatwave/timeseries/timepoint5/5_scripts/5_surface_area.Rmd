---
title: "Surface Area Calculations from Wax Dipping for Heatwave timepoint 4"
...
#load wax data
wax.data <- read.csv("timepoint5/5_data/5_surface_area/5_surface_area_data.csv", header=TRUE)
...
smpls%>%
  ...
  select(fragment_ID, surface.area.cm2, timepoint)%>%
    write_csv("timepoint5/5_output/5_surface.area.calc.csv")
```

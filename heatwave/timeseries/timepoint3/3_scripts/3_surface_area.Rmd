---
title: "Surface Area Calculations from Wax Dipping for Heatwave timepoint 3"
...
#load wax data
wax.data <- read.csv("timepoint3/3_data/3_surface_area/3_surface_area_data.csv", header=TRUE)
...
smpls%>%
  ...
  select(fragment_ID, surface.area.cm2, timepoint)%>%
    write_csv("timepoint3/3_output/3_surface.area.calc.csv")
```

...
larvae1022 <-read.csv("spawning/data/survivorship/cohort_survivorship/cohort1022_survivorship.data.csv", header=T, na.strings="NA") #load larval survivorship dataset
...
```{r}
#load and manipulate data sets
larvae1023 <-read.csv("spawning/data/survivorship/cohort_survivorship/cohort1023_survivorship.data.csv", header=T, na.strings="NA") #load larval survivorship dataset
...
qqPlot(residuals(model1d)) 
#leveneTest(residuals(model1d)~history * as.factor(timepoint), data=z) #passes
```
...
ggsave(filename="figures/larval.survivorship/larvalsurv_three_panel.pdf", plot=figure_surv, dpi=500, width=20
       , height=14, units="in")
...
ggsave(filename="spawning/figures/larval.survivorship/larvalsurv_pooled.pdf", plot=figure_surv_2, dpi=500, width=15
       , height=14, units="in")
ggsave(filename="spawning/figures/larval.survivorship/larvalsurv_pooled.jpg", plot=figure_surv_2, dpi=500, width=15
       , height=14, units="in")

...
size_plot<-size %>%
  ...
  xlab(expression(bold(paste("Treatment"))))+
    ...
    ggtitle("Kruskal-Wallis, p = 0.018") +
      annotate("text", x = 1.4, y = 0.220, label = "*", size = 12) +
    theme_classic() + 
...
size_plot_mean<-size %>%
  ...
  summarise(mean=mean(volume, na.rm=TRUE), 
   ...
   xlab(expression(bold(paste("Treatment"))))+
    theme_classic() + 
    annotate("text", x = 1.4, y = 0.110, label = "*", size = 12) +
    ylim(0,0.12)+
    theme(plot.title = element_text(hjust = 0.5, vjust = -0.1),
      legend.position="none",
      axis.title=element_text(face="bold", size=16, color="black"),
...
Kruskal-Wallis chi-squared = 6.0583, df = 1, p-value = 0.01384
...
total_fert_success_plot <- calculate_fert_success %>%
  ...
  xlab(expression(bold(paste("Treatment"))))+
    ...
    ggtitle("Kruskal-Wallis, p = 0.020") +
      annotate("text", x = 1.4, y = 85, label = "*", size = 12) +
    theme_classic() + 
    theme(plot.title = element_text(hjust = 0.5, vjust = -0.1),
      legend.position="none",
      axis.title=element_text(face="bold", size=16, color="black"),
...
bundle_plot <- bundle %>%
  ...
  xlab(expression(bold(paste("Treatment"))))+
   ...
   scale_y_continuous(expand = c(0, 0), limits = c(0, 20)) +
      ...
      annotate("text", x = 1.4, y = 18, label = "*", size = 12) +
    theme_classic() + 
    theme(plot.title = element_text(hjust = 0.5, vjust = -0.1),
      legend.position="none",
      axis.title=element_text(face="bold", size=16, color="black"),
      ...
      legend.title=element_text(face="bold", size=14), 
      legend.text=element_text(size=14), 
      axis.text.x=element_text(angle=45, hjust=1, color="black"));bundle_plot

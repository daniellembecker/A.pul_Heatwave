...
```{r}
size_model<-aov(mean_volume~treatment, data=mean_egg_size)
summary(size_model)
qqPlot(residuals(size_model))
leveneTest(residuals(size_model)~treatment, data=mean_egg_size)
```

Passes normality and homogeneity of variance tests, anova is good, egg size higher in hot treatment compared to ambient

            Df   Sum Sq  Mean Sq F value   Pr(>F)    
treatment    1 0.007012 0.007012   15.48 0.000889 ***
Residuals   19 0.008605 0.000453                     
...
Meets assumptions for normality and homogeneity of variance but eggs per bundle are significantly higher in the heated parental history treatment.
